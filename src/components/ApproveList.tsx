  ...
  const fetchPending = async () => {
    ...
    const pending = (data.posts || []).filter(
      (p: Post) =>
        ...
        p.status === 'ERRO' ||
        p.instagram_publish_status === 'ERRO_PUBLICACAO',
    );
